    <nav class="bg-white/80 backdrop-blur-md border-b border-gray-100 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20">
                ...
                <div class="hidden md:flex md:space-x-8 items-center">
                    ...
                    <a href="#" class="text-gray-500 hover:text-indigo-600 hover:border-b-2 hover:border-indigo-300 px-1 pt-1 text-sm font-medium transition-all duration-300">
                        Take Quiz
                    </a>
                </div>
        ...
        <div class="hidden md:hidden bg-white border-t border-gray-100" id="mobile-menu">
            <div class="pt-2 pb-3 space-y-1 px-4">
                ...
                <a href="#" class="border-l-4 border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 text-base font-medium">Take Quiz</a>
            </div>
