...
<body class="bg-slate-50 flex items-center justify-center min-h-screen px-4 py-8">
    ...
    <div class="w-full max-w-sm  overflow-hidden border border-slate-100">

        <div class="px-8 pt-8 pb-6">
            <h1 class="text-2xl font-bold text-slate-900 text-center">Forgot Password</h1>
            <p class="text-center text-slate-500 text-sm mt-2">Enter your email to receive reset link</p>
        </div>

    <form method="POST" action="{{ route('ForgotPassword') }}" class="px-8 pb-8 space-y-5">
        @csrf
